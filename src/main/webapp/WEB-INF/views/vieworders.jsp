	...
	<div class="container-fluid" id="left_body">
		<div class="row">
			...
			<div class="col-xl-8 col-md-8 col-8">
				<div class="jumbotron">
					<a href="${pageContext.request.contextPath }/admin/view_new_orders" class="btn btn-info" role="button">View All New Orders</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container" id="table_body">
		<div class="row">
			<div class="col-xl-12 col-md-12 col-12">
				<div class="jumbotron">
					<h2>Here is the list of all New Orders:</h2>
					<br>
					<table class="table">
						...
						<tbody>
							<c:forEach items="${orderList}" var="olist">
								<tr>
									...
									<td>${olist.carDetails.carID}</td>
									<td>${olist.userLogin.userID}</td>
									<td>${olist.address}</td>
									<td>${olist.mode}</td>
									<td><a class="btn btn-info" href="${pageContext.request.contextPath }/admin/updateorder/${olist.orderID}/${olist.carDetails.carID}">Mark Completed</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
